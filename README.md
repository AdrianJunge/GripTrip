# UC3M Web Application Project - GripTrip
A web application implemented for the `Web Application Project` [@UC3M](https://www.uc3m.es/bachelor-degree/data-science#program:~:text=Web%20Applications) with which you can create and manage climbing trips with your friends with an interactive world map.
...
### Additional functionality for evaluation
- **UI/UX design**
...
By using the JavaScript fetch API, user roles can be updated without a page reload.
